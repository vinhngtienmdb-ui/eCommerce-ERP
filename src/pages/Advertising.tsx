  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <TabsList>
          <TabsTrigger value="bidding">{t("advertising.tabs.bidding")}</TabsTrigger>
          <TabsTrigger value="analytics">{t("advertising.tabs.analytics")}</TabsTrigger>
          <TabsTrigger value="revenue">{t("advertising.tabs.revenue")}</TabsTrigger>
        </TabsList>

        <TabsContent value="bidding" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>{t("advertising.tabs.bidding")}</CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="analytics" className="space-y-4">
          ...
          <Card>
            <CardHeader>
              <CardTitle>{t("advertising.tabs.analytics")}</CardTitle>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
